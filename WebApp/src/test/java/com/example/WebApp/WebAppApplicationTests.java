package com.example.WebApp; import org.junit.jupiter.api.Test;
...
class WebAppApplicationTests {
	...
	@Test
	public void shouldReturnDefaultMessage() throws Exception { this.mockMvc.perform(get("/"))
	...
	@Test
	public void shouldReturnDefaultMessageTulio() throws Exception { this.mockMvc.perform(get("/tulio"))
			.andDo(print()).andExpect(status().isOk())
			.andExpect(content()
					.string(containsString("Hello, Tulio!")));
	}
